...
let colors = ['red','green', 'white', 'blue','purple']; //untuk pieplot
...
let urlAPI = "https://api.openweathermap.org/data/2.5/weather?q=Tangerang&appid=a10ced7e85d94274f0d6d7f50d893614&units=metric"
let dataSheet;
let dataAPI;
let xData;
let yData;
